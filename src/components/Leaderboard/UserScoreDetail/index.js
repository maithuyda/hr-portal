...
const UserScoreDetail = (props) => {
  ...
  const scoreThisWeekWidth =
    (props.scoreThisWeek / props.maxScoreThisWeek) * 100;
  return (
    <li>
      <span className="avatar">
        <a href={`/u/${props.name}`}>
          <span className="round initials background_color purple">
            {props.name[0]}
          </span>
        </a>
      </span>
      ...
      <div className="data">
        ...
        <div className="meter this_week">
          <div
            className="gauge"
            style={{ width: `${scoreThisWeekWidth}%` }}
          ></div>
