        ...
        <ContentWrapper>
            ...
            <div className="join-today-content_wrapper">
                <div className="join-today_content">
                    <p>
                        Get access to maintain your own <em>custom personal lists</em>, <em>track what you've seen</em>{' '}
                        and search and filter for <em>what to watch next</em>—regardless if it's in theatres, on TV or
